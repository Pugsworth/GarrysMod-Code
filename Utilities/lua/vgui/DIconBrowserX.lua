...
local pnlTextBar = vgui.Register("DIconBrowserX_TextBar", {
...
local pnlTextBarOverlay = vgui.Register("DIconBrowserX_TextBarOverlay", {
	Init = function(self)
...
function PANEL:Init()
	...
	self.searchBar:SetImage("icon16/cross.png");
...
concommand.Add("vgui_show_iconbrowser", CreateIconBrowser);
...
--[[
	...
	TODO:
		abstract textbox logic to separate element
		clean up logic and code
		upload to github (new)
		release
]]
