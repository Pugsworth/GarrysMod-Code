...
SKIN.PrintName 		= "Gwen Default Derma Skin"
...
SKIN.tex.Window.Close			= GWEN.CreateTextureNormal( 0, 224, 31, 31 )
SKIN.tex.Window.Close_Hover		= GWEN.CreateTextureNormal( 32, 224, 31, 31 )
SKIN.tex.Window.Close_Down		= GWEN.CreateTextureNormal( 64, 224, 31, 31 )
...
SKIN.Colours.Window = {}
SKIN.Colours.Window.TitleActive			= GWEN.TextureColor( 4 + 8 * 8, 508 )
...
derma.DefineSkin( "GWENDefault", "GWEN Default", SKIN )
